...
pub(crate) const DATA_1_10_1_0: WotDataForVersion = WotDataForVersion {
    ...
    entities: &[
        EntityData {
            ...
            exposed_props:   &[
                PropData {
                    name:          "requiredVersion_11010",
                    default_value: WotXmlDefaultValue::Str("	ru_1.10.1_6	"),
                    datatype:      WotXmlType::String,
                    size:          65535,
                },
                PropData {
        ...
        EntityData {
            ...
            exposed_methods: &[
                ...
                MethodData {
                    name: "showAuraSoulsWarningHint",
                    args: &[],
                    size: 1,
                },
                MethodData {
                    name: "showAuraHealthWarningHint",
                    args: &[],
                    size: 1,
                },
                MethodData {
                    name: "hideAuraWarningHint",
                    args: &[],
                    size: 1,
                },
                MethodData {
                ...
                MethodData {
                    name: "showAuraVictimMarkerIcon",
                    args: &[WotXmlType::Int32],
                    size: 5,
                },
                MethodData {
                    name: "hideAuraVictimMarkerIcon",
                    args: &[WotXmlType::Int32],
                    size: 5,
                },
                MethodData {
                ...
                MethodData {
                    name: "updateScenarioTimer",
                    args: &[WotXmlType::Python],
                    size: 65536,
                },
                MethodData {
                    name: "sendPlayerBattleLogNotification",
                    args: &[WotXmlType::String, WotXmlType::Python],
                    size: 65536,
                },
                MethodData {
                    name: "sendEquipmentBattleLogNotification",
                    args: &[WotXmlType::UInt16, WotXmlType::String, WotXmlType::UInt8],
                    size: 65536,
                },
                MethodData {
        ...
        EntityData {
            ty:              EnvironmentSwitcher,
            exposed_props:   &[],
            exposed_methods: &[],
        },
        EntityData {
            ty:              HalloweenHangarTank,
            exposed_props:   &[
                PropData {
                    name:          "cameraStaticCollisions",
                    default_value: WotXmlDefaultValue::Int(1),
                    datatype:      WotXmlType::UInt8,
                    size:          1,
                },
        ...
        EntityData {
            ty:              HalloweenHangarTankHeadlight,
            exposed_props:   &[
                PropData {
                    name:          "modelName",
                    default_value: WotXmlDefaultValue::Str(""),
        ...
        EntityData {
            ...
            exposed_methods: &[MethodData {
                name: "onChangeState",
                args: &[WotXmlType::Int32, WotXmlType::Int32, WotXmlType::String],
                size: 65536,
            }],
        },
    ],
