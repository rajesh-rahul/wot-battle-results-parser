...
pub(crate) const DATA_1_14_1_0: WotDataForVersion = WotDataForVersion {
    special_formats: SpecialFormat {
        create_avatar: &[
            ...
            PropData {
                name:          "clientData",
                default_value: WotXmlDefaultValue::EmptyDict,
                datatype:      WotXmlType::Python,
                size:          65535,
            },
        ],
    ...
    entities: &[
        EntityData {
            ...
            exposed_props:   &[
                PropData {
                    name:          "requiredVersion_11410",
                    default_value: WotXmlDefaultValue::Str("	ru_1.14.1_6	"),
                    datatype:      WotXmlType::String,
                    size:          65535,
                },
                PropData {
        ...
        EntityData {
            ...
            exposed_methods: &[
                ...
                MethodData {
                    ...
                    args: &[WotXmlType::UInt32, WotXmlType::String, WotXmlType::UInt8],
                    size: 65536,
                },
                MethodData {
