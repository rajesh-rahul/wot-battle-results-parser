...
pub(crate) const DATA_1_18_1_0: WotDataForVersion = WotDataForVersion {
    ...
    entities: &[
        EntityData {
            ...
            exposed_props:   &[
                PropData {
                    name:          "requiredVersion_11810",
                    default_value: WotXmlDefaultValue::Str("	ru_1.18.1_5	"),
                    datatype:      WotXmlType::String,
                    size:          65535,
                },
                PropData {
