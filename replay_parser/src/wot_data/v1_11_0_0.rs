...
pub(crate) const DATA_1_11_0_0: WotDataForVersion = WotDataForVersion {
    ...
    entities: &[
        EntityData {
            ...
            exposed_props:   &[
                PropData {
                    name:          "requiredVersion_11100",
                    default_value: WotXmlDefaultValue::Str("	ru_1.11.0_2	"),
                    datatype:      WotXmlType::String,
                    size:          65535,
                },
                PropData {
        ...
        EntityData {
            ...
            exposed_methods: &[
                ...
                MethodData {
                    name: "closeChooseSpawnKeyPointsWindow",
                    args: &[],
                    size: 1,
                },
                MethodData {
                ...
                MethodData {
                    name: "receiveSpawnKeyPointsCloseTime",
                    args: &[WotXmlType::Float32],
                    size: 5,
                },
                MethodData {
                ...
                MethodData {
                    ...
                    args: &[WotXmlType::FixedDict {
                        inner:      &[
                            ("circularVisionRadius", WotXmlType::UInt16),
                            ("gunPiercing", WotXmlType::Float32),
                        ],
                        allow_none: false,
                    }],
                    size: 7,
                ...
                MethodData {
                    name: "receiveAvailableSpawnKeyPoints",
                    args: &[WotXmlType::Array {
                        inner: &WotXmlType::FixedDict {
                            inner:      &[("guid", WotXmlType::String), ("position", WotXmlType::Vector2)],
                            allow_none: false,
                        },
                        size:  None,
                    }],
                ...
                MethodData {
                    name: "receiveTeamSpawnKeyPoints",
                    args: &[WotXmlType::Array {
                        inner: &WotXmlType::FixedDict {
                            inner:      &[("vehID", WotXmlType::Int32), ("guid", WotXmlType::String)],
                            allow_none: false,
                        },
                        size:  None,
                    }],
                    ...
                    args: &[
                        ...
                        WotXmlType::Array {
                            inner: &WotXmlType::FixedDict {
                                inner:      &[
                                    ("id", WotXmlType::UInt8),
                                    ("leftTime", WotXmlType::Int16),
                                    ("baseTime", WotXmlType::Int16),
                                ],
                                allow_none: false,
                            },
                            size:  None,
        ...
        EntityData {
            ...
            exposed_props:   &[
                PropData {
                    name:          "vehiclesAverageBattleLevel",
                    default_value: WotXmlDefaultValue::Null,
                ...
                PropData {
                    ...
                    datatype:      WotXmlType::Array {
                        inner: &WotXmlType::FixedDict {
                            inner:      &[("id", WotXmlType::Int32), ("position", WotXmlType::Vector3)],
                            allow_none: false,
                        },
                        size:  None,
                    },
        ...
        EntityData {
            ty:              CustomizableNewYearSceneObject,
            exposed_props:   &[PropData {
        ...
        EntityData {
            ...
            exposed_props:   &[
                ...
                PropData {
                    name:          "fov",
                    default_value: WotXmlDefaultValue::Int(95),
                    datatype:      WotXmlType::UInt32,
                    size:          4,
                },
                PropData {
                ...
                PropData {
                    name:          "yawConstraints",
                    default_value: WotXmlDefaultValue::List(&[
                        WotXmlDefaultValue::Float(-180.0),
                        WotXmlDefaultValue::Float(180.0),
                    ]),
                    datatype:      WotXmlType::Vector2,
                    size:          8,
                ...
                PropData {
                    ...
                    default_value: WotXmlDefaultValue::List(&[
                        WotXmlDefaultValue::Float(6.5),
                        WotXmlDefaultValue::Float(12.0),
                    ]),
                    datatype:      WotXmlType::Vector2,
                    size:          8,
                },
        ...
        EntityData {
            ...
            exposed_props:   &[
                ...
                PropData {
                    name:          "regularEffectName",
                    default_value: WotXmlDefaultValue::Str(""),
                    datatype:      WotXmlType::String,
                    size:          65535,
                },
                PropData {
                    name:          "hangingEffectName",
                    default_value: WotXmlDefaultValue::Str(""),
                    datatype:      WotXmlType::String,
                    size:          65535,
                },
        ...
        EntityData {
            ty:              NewYearBaseEntryObject,
            exposed_props:   &[],
            exposed_methods: &[],
        },
        EntityData {
            ty:              NewYearTalismanEntryObject,
            exposed_props:   &[
                PropData {
                    name:          "progressUpAnimation",
                    default_value: WotXmlDefaultValue::Str(""),
                    datatype:      WotXmlType::String,
                    size:          65535,
                },
                PropData {
                    name:          "billboardAnimation",
                    default_value: WotXmlDefaultValue::Str(""),
                    datatype:      WotXmlType::String,
                    size:          65535,
                },
        ...
        EntityData {
            ty:              NewYearCelebrityEntryObject,
            exposed_props:   &[],
            exposed_methods: &[],
        },
        EntityData {
            ty:              NewYearTalismanPreviewObject,
            exposed_props:   &[],
            exposed_methods: &[],
        },
        EntityData {
            ty:              NewYearTalismanPreviewCamera,
            exposed_props:   &[
                PropData {
                    name:          "time",
                    default_value: WotXmlDefaultValue::Null,
        ...
        EntityData {
            ...
            exposed_props:   &[
                ...
                PropData {
                    name:          "effectNormalState",
                    default_value: WotXmlDefaultValue::Str(""),
                    datatype:      WotXmlType::String,
                    size:          65535,
                },
                PropData {
                    name:          "effectTrueState",
                    default_value: WotXmlDefaultValue::Str(""),
                    datatype:      WotXmlType::String,
                    size:          65535,
                },
                PropData {
                    name:          "effectFalseState",
                    default_value: WotXmlDefaultValue::Str(""),
                    datatype:      WotXmlType::String,
                    size:          65535,
                },
