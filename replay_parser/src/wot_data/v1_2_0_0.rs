...
pub(crate) const DATA_1_2_0_0: WotDataForVersion = WotDataForVersion {
    ...
    entities: &[
        EntityData {
            ...
            exposed_props:   &[
                PropData {
                    ...
                    default_value: WotXmlDefaultValue::Str("	ru_1.2.0_8	"),
                    datatype:      WotXmlType::String,
                    size:          65535,
                },
                PropData {
        ...
        EntityData {
            ...
            exposed_methods: &[
                ...
                MethodData {
                    name: "createArenaObstacle",
                    args: &[WotXmlType::Python],
                    size: 65536,
                },
                MethodData {
                    name: "destroyArenaObstacle",
                    args: &[WotXmlType::String],
                    size: 65536,
                },
                MethodData {
