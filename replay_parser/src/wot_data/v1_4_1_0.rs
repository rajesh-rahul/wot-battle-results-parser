...
pub(crate) const DATA_1_4_1_0: WotDataForVersion = WotDataForVersion {
    ...
    entities: &[
        EntityData {
            ...
            exposed_props:   &[
                PropData {
                    name:          "requiredVersion_14100",
                    default_value: WotXmlDefaultValue::Str("	ru_1.4.1_4	"),
                    datatype:      WotXmlType::String,
                    size:          65535,
                },
                PropData {
