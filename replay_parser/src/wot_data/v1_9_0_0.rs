...
pub(crate) const DATA_1_9_0_0: WotDataForVersion = WotDataForVersion {
    ...
    entities: &[
        EntityData {
            ...
            exposed_props:   &[
                PropData {
                    name:          "requiredVersion_19000",
                    default_value: WotXmlDefaultValue::Str("	ru_1.9.0_7	"),
                    datatype:      WotXmlType::String,
                    size:          65535,
                },
                PropData {
        ...
        EntityData {
            ...
            exposed_methods: &[
                ...
                MethodData {
                    ...
                    args: &[WotXmlType::Int32, WotXmlType::String, WotXmlType::UInt8],
                    size: 65536,
                },
                MethodData {
                    name: "notifyClients",
        ...
        EntityData {
            ty:              CustomizableSE20SceneObject,
            exposed_props:   &[PropData {
                name:          "anchorName",
                default_value: WotXmlDefaultValue::Str(""),
                datatype:      WotXmlType::String,
        ...
        EntityData {
            ty:              SE20HangarVehicle,
            exposed_props:   &[
                PropData {
                    name:          "vehicleIndex",
                    default_value: WotXmlDefaultValue::Int(-1),
                    datatype:      WotXmlType::Int8,
                    size:          1,
                },
                PropData {
                    name:          "markerHeightFactor",
        ...
        EntityData {
            ty:              SE20ClientSelectableObject,
            exposed_props:   &[
                PropData {
                    name:          "boundingSphereSize",
                    default_value: WotXmlDefaultValue::Null,
                    datatype:      WotXmlType::Vector3,
                    size:          12,
                },
                PropData {
                    name:          "boundingSphereOffset",
                    default_value: WotXmlDefaultValue::Null,
                    datatype:      WotXmlType::Vector3,
                    size:          12,
                },
        ...
        EntityData {
            ...
            exposed_methods: &[MethodData {
                name: "playEffect",
                args: &[WotXmlType::String, WotXmlType::Vector3],
                size: 65536,
            }],
        },
        EntityData {
                    ...
                    datatype:      WotXmlType::Array {
                        inner: &WotXmlType::FixedDict {
                            inner:      &[
                                ...
                                ("nextStrikeTime", WotXmlType::UInt32),
                            ],
                            allow_none: false,
                        },
                        size:  None,
        ...
        EntityData {
            ty:              PersonalDeathZonesHelper,
            exposed_props:   &[
                PropData {
                    name:          "warningTimeShouldEndAt",
                    default_value: WotXmlDefaultValue::Null,
                    datatype:      WotXmlType::Float32,
                    size:          4,
                },
