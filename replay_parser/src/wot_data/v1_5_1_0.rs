...
pub(crate) const DATA_1_5_1_0: WotDataForVersion = WotDataForVersion {
    ...
    entities: &[
        EntityData {
            ...
            exposed_props:   &[
                PropData {
                    name:          "requiredVersion_15100",
                    default_value: WotXmlDefaultValue::Str("	ru_1.5.1_7	"),
                    datatype:      WotXmlType::String,
                    size:          65535,
                },
                PropData {
        ...
        EntityData {
            ...
            exposed_methods: &[
                ...
                MethodData {
                    name: "setLastStandActive",
                    args: &[WotXmlType::UInt8, WotXmlType::UInt16],
                    size: 4,
                },
                MethodData {
                ...
                MethodData {
                    name: "displayLastStandOnVehicle",
                ...
                MethodData {
                    name: "addRespawnGroup",
                    args: &[WotXmlType::UInt8, WotXmlType::Vector3, WotXmlType::UInt8],
                    size: 15,
                },
                MethodData {
                ...
                MethodData {
                    name: "eventUpdateRespawnVehicles",
                    args: &[WotXmlType::Array {
                        inner: &WotXmlType::FixedDict {
                            inner:      &[
                                ("compDescr", WotXmlType::String),
                                ("isEnable", WotXmlType::UInt8),
                                ("settings", WotXmlType::UInt16),
                            ],
                            allow_none: false,
                        },
                ...
                MethodData {
                    name: "onHealthDataChanged",
                    args: &[WotXmlType::String, WotXmlType::UInt16],
                    size: 65536,
                },
                MethodData {
                    name: "setConfigForCurrentMap",
                    args: &[WotXmlType::String],
                    size: 65536,
                },
                MethodData {
                    name: "onVehicleDangerousZoneTriggered",
                    args: &[
                        WotXmlType::Int32,
                        WotXmlType::String,
                        WotXmlType::UInt16,
        ...
        EntityData {
            ...
            exposed_props:   &[
                ...
                PropData {
                    name:          "stateMachinePath",
                    default_value: WotXmlDefaultValue::Str(""),
                    datatype:      WotXmlType::String,
                    size:          65535,
                },
                PropData {
                    name:          "stateMachineBoolParamName",
                    default_value: WotXmlDefaultValue::Str(""),
                    datatype:      WotXmlType::String,
                    size:          65535,
                },
