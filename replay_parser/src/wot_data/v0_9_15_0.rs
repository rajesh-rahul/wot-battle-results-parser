...
pub(crate) const DATA_0_9_15_0: WotDataForVersion = WotDataForVersion {
    ...
    entities: &[
        EntityData {
            ...
            exposed_props:   &[
                PropData {
                    name:          "requiredVersion_91510",
                    default_value: WotXmlDefaultValue::Str("	ru_0.9.15.1	"),
                    datatype:      WotXmlType::String,
                    size:          65535,
                },
                PropData {
