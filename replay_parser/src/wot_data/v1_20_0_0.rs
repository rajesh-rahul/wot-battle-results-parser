...
pub(crate) const DATA_1_20_0_0: WotDataForVersion = WotDataForVersion {
    ...
    entities: &[
        EntityData {
            ...
            exposed_props:   &[
                PropData {
                    name:          "requiredVersion_12000",
                    default_value: WotXmlDefaultValue::Str("	ru_1.20.0_2	"),
                    datatype:      WotXmlType::String,
                    size:          65535,
                },
                PropData {
        ...
        EntityData {
            ...
            exposed_props:   &[
                ...
                PropData {
                    ...
                    datatype:      WotXmlType::FixedDict {
                        inner:      &[
                            ("stunFinishTime", WotXmlType::Float64),
                            ("stunType", WotXmlType::UInt8),
                        ],
                        allow_none: false,
                    },
                    size:          9,
