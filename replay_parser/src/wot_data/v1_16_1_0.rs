...
pub(crate) const DATA_1_16_1_0: WotDataForVersion = WotDataForVersion {
    ...
    entities: &[
        EntityData {
            ...
            exposed_props:   &[
                PropData {
                    name:          "requiredVersion_11610",
                    default_value: WotXmlDefaultValue::Str("	ru_1.16.1_5	"),
                    datatype:      WotXmlType::String,
                    size:          65535,
                },
                PropData {
                    name:          "requiredVersion_11010",
                    default_value: WotXmlDefaultValue::Str("	1.10.1	"),
                    datatype:      WotXmlType::String,
                    size:          65535,
                },
                PropData {
        ...
        EntityData {
            ...
            exposed_methods: &[
                ...
                MethodData {
                    name: "stopVehicleControl",
                    args: &[],
                    size: 1,
                },
                MethodData {
                    name: "onStartVehicleControlFailed",
                    args: &[],
                    size: 1,
                },
                MethodData {
                ...
                MethodData {
                    name: "onRTSEvent",
                    args: &[WotXmlType::UInt8, WotXmlType::Int32, WotXmlType::Vector3],
                    size: 18,
                },
                MethodData {
                    ...
                    args: &[
                        ...
                        WotXmlType::FixedDict {
                            inner:      &[
                                ...
                                ("damageSupply", WotXmlType::UInt32),
                ...
                MethodData {
                    name: "onRTSQueryResult",
                    args: &[WotXmlType::Array {
                        inner: &WotXmlType::FixedDict {
                            inner:      &[
                                ("queryID", WotXmlType::UInt32),
                                ("resultCode", WotXmlType::UInt8),
                                ("packedPosition", WotXmlType::Vector3),
                            ],
                            allow_none: false,
                        },
                        size:  None,
        ...
        EntityData {
            ty:              ClientSelectableRTSLeaderboard,
            exposed_props:   &[],
            exposed_methods: &[],
        },
        EntityData {
