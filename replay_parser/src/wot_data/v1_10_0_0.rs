...
pub(crate) const DATA_1_10_0_0: WotDataForVersion = WotDataForVersion {
    ...
    entities: &[
        EntityData {
            ...
            exposed_props:   &[
                PropData {
                    ...
                    default_value: WotXmlDefaultValue::Str("	ru_1.10.0_7	"),
                    datatype:      WotXmlType::String,
                    size:          65535,
                },
                PropData {
        ...
        EntityData {
            ty:              ClientSelectableAdventCalendarObject,
            exposed_props:   &[],
            exposed_methods: &[],
        },
        EntityData {
