...
pub(crate) const DATA_1_15_0_0: WotDataForVersion = WotDataForVersion {
    ...
    entities: &[
        EntityData {
            ...
            exposed_props:   &[
                PropData {
                    name:          "requiredVersion_11500",
                    default_value: WotXmlDefaultValue::Str("	ru_1.15.0_8	"),
                    datatype:      WotXmlType::String,
                    size:          65535,
                },
                PropData {
            ...
            exposed_props:   &[
                ...
                PropData {
                    ...
                    datatype:      WotXmlType::Array {
                        inner: &WotXmlType::FixedDict {
                            inner:      &[
                                ("point", WotXmlType::Vector3),
                                ("anchorName", WotXmlType::String),
                                ("flightSpeed", WotXmlType::Float32),
                            ],
                            allow_none: false,
                        },
                        size:  None,
        ...
        EntityData {
            ty:              NewYearJukeboxSelectableObject,
            exposed_props:   &[PropData {
                name:          "sideName",
                default_value: WotXmlDefaultValue::Str(""),
                datatype:      WotXmlType::String,
