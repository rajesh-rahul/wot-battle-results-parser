...
pub(crate) const DATA_1_12_0_0: WotDataForVersion = WotDataForVersion {
    ...
    entities: &[
        EntityData {
            ...
            exposed_props:   &[
                PropData {
                    name:          "requiredVersion_11200",
                    default_value: WotXmlDefaultValue::Str("	ru_1.12.0_5	"),
                    datatype:      WotXmlType::String,
                    size:          65535,
                },
                PropData {
        ...
        EntityData {
            ty:              ClientSelectableBlackMarketObject,
            exposed_props:   &[],
            exposed_methods: &[],
        },
    ],
