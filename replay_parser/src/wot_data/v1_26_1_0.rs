...
pub(crate) const DATA_1_26_1_0: WotDataForVersion = WotDataForVersion {
    special_formats: SpecialFormat {
        create_avatar: &[
            ...
            PropData {
                name:          "battleChatRestriction",
                default_value: WotXmlDefaultValue::Null,
                datatype:      WotXmlType::FixedDict {
                    inner:      &[
                        ("isBattleChatDisabled", WotXmlType::UInt8),
                        ("restrictionReasonID", WotXmlType::Int8),
                    ],
                    allow_none: false,
                },
                size:          2,
            ...
            PropData {
                name:          "goodiesSnapshot",
                default_value: WotXmlDefaultValue::Null,
                datatype:      WotXmlType::Array {
                    inner: &WotXmlType::FixedDict {
                        inner:      &[
                            ("goodieID", WotXmlType::UInt32),
                            ("lifetime", WotXmlType::UInt16),
                            ("useby", WotXmlType::UInt64),
                            (
                                "resource",
                                WotXmlType::FixedDict {
                                    inner:      &[
                                        ("type", WotXmlType::UInt8),
                                        ("value", WotXmlType::UInt16),
                                        ("isPercentage", WotXmlType::UInt8),
                                    ],
                                    allow_none: true,
                                },
                            ),
                            (
                                ...
                                WotXmlType::FixedDict {
                                    inner:      &[
                                        ("state", WotXmlType::UInt8),
                                        ("finishTime", WotXmlType::Float64),
                                        ("count", WotXmlType::UInt16),
                                        ("expirations", WotXmlType::Python),
                                    ],
                                    allow_none: true,
                                },
                            ),
    ...
    entities: &[
        EntityData {
            ...
            exposed_props:   &[
                ...
                PropData {
                    name:          "requiredVersion_12610",
                    default_value: WotXmlDefaultValue::Str("eu_1.26.1_2"),
                    datatype:      WotXmlType::String,
                    size:          65535,
                },
                PropData {
        ...
        EntityData {
            ...
            exposed_props:   &[
                ...
                PropData {
                    name:          "shouldSendKillcamSimulationData",
                    default_value: WotXmlDefaultValue::Null,
                    datatype:      WotXmlType::UInt8,
                    size:          1,
                },
                ...
                PropData {
                    name:          "ownVehicleHullAimingPitchPacked",
                    default_value: WotXmlDefaultValue::Null,
            ...
            exposed_methods: &[
                ...
                MethodData {
                    name: "onCrewRoleFactorAndRankUpdate",
                    args: &[WotXmlType::Float32, WotXmlType::Int64, WotXmlType::UInt8],
                    size: 14,
                },
                MethodData {
                ...
                MethodData {
                    ...
                    args: &[WotXmlType::Array {
                        inner: &WotXmlType::FixedDict {
                            inner:      &[
                                ("vehTypeCompDescr", WotXmlType::UInt32),
                ...
                MethodData {
                    name: "syncPurchasedAbilities",
                    args: &[WotXmlType::Array {
                        inner: &WotXmlType::Int64,
                        size:  None,
                    }],
                    size: 65536,
                },
                MethodData {
                    name: "onRandomReserveOffer",
                    args: &[
                        WotXmlType::Array {
                            inner: &WotXmlType::Int32,
                            size:  None,
                ...
                MethodData {
                    ...
                    args: &[WotXmlType::FixedDict {
                        inner:      &[
                            ...
                            ("attackReasonExtID", WotXmlType::Int8),
                        ],
                        allow_none: true,
                    }],
                    size: 65536,
                ...
                MethodData {
                    name: "handleScriptEventFromServer",
                    args: &[
                        WotXmlType::String,
                        WotXmlType::String,
                        WotXmlType::String,
                ...
                MethodData {
                    name: "setUpdatedGoodiesSnapshot",
                    args: &[WotXmlType::Array {
                        inner: &WotXmlType::FixedDict {
                            inner:      &[
                                ("goodieID", WotXmlType::UInt32),
        ...
        EntityData {
            ...
            exposed_props:   &[
                ...
                PropData {
                    name:          "enableExternalRespawn",
                    default_value: WotXmlDefaultValue::Int(0),
                    datatype:      WotXmlType::UInt8,
                    size:          1,
                },
                PropData {
                    name:          "botDisplayStatus",
                    default_value: WotXmlDefaultValue::Null,
                    datatype:      WotXmlType::UInt8,
                    size:          1,
                },
                ...
                PropData {
                    ...
                    datatype:      WotXmlType::Array {
                        inner: &WotXmlType::FixedDict {
                            inner:      &[
                                ("perkID", WotXmlType::Int32),
                                ("state", WotXmlType::UInt8),
                                ("coolDown", WotXmlType::Float32),
                                ("lifeTime", WotXmlType::Float64),
                            ],
                            allow_none: true,
                        },
                        size:  None,
                ...
                PropData {
                    name:          "perksRibbonNotify",
                    default_value: WotXmlDefaultValue::Null,
                    datatype:      WotXmlType::Array {
                        inner: &WotXmlType::FixedDict {
                            inner:      &[("perkID", WotXmlType::Int32), ("endTime", WotXmlType::Float64)],
                            allow_none: true,
                        },
                        size:  None,
                    },
                ...
                PropData {
                    ...
                    datatype:      WotXmlType::FixedDict {
                        inner:      &[
                                    ...
                                    inner:      &[(
                                        ...
                                        WotXmlType::Array {
                                            inner: &WotXmlType::FixedDict {
                                                inner:      &[
                                                    ("id", WotXmlType::Int32),
                                                    ("progress", WotXmlType::Float32),
                                                    ("grade", WotXmlType::Int8),
                                                ],
                                                allow_none: false,
                                            },
                                            size:  None,
                            ...
                            ("showDogTagToKiller", WotXmlType::UInt8),
                        ],
                        allow_none: false,
                    },
                    size:          65535,
            ...
            exposed_methods: &[
                MethodData {
                    name: "onVehiclePickup",
                    args: &[],
                    size: 1,
                },
                MethodData {
                    name: "showShooting",
                    args: &[WotXmlType::UInt8, WotXmlType::Int8],
                    size: 3,
                },
                MethodData {
                    name: "onPushed",
                ...
                MethodData {
                    name: "onExtraHitted",
                    args: &[WotXmlType::Int16, WotXmlType::Vector3],
                    size: 15,
                },
                MethodData {
        ...
        EntityData {
            ...
            exposed_props:   &[
                ...
                PropData {
                    name:          "simulationData_siegeState",
                    default_value: WotXmlDefaultValue::Null,
                    datatype:      WotXmlType::UInt8,
                    size:          1,
                },
                PropData {
                    name:          "simulationData_health",
                    default_value: WotXmlDefaultValue::Null,
                    datatype:      WotXmlType::Int16,
                    size:          2,
                },
                PropData {
                    name:          "simulationData_engineMode",
                    default_value: WotXmlDefaultValue::Null,
                    datatype:      WotXmlType::Array {
                        inner: &WotXmlType::UInt8,
                        size:  Some(2),
                ...
                PropData {
                    name:          "simulationData_wheelsState",
                    default_value: WotXmlDefaultValue::Null,
                    datatype:      WotXmlType::UInt16,
                    size:          2,
                },
                PropData {
                    name:          "simulationData_tracksInAir",
                    default_value: WotXmlDefaultValue::Null,
                    datatype:      WotXmlType::Array {
                        inner: &WotXmlType::UInt8,
                        size:  Some(2),
                ...
                PropData {
                    name:          "simulationData_gunAngles",
                    default_value: WotXmlDefaultValue::Null,
                    datatype:      WotXmlType::Vector2,
                    size:          8,
                },
                PropData {
                    name:          "simulationData_turretAndGunSpeed",
                    default_value: WotXmlDefaultValue::Null,
                    datatype:      WotXmlType::Vector2,
                    size:          8,
                },
                PropData {
                    name:          "simulationData_position",
                    default_value: WotXmlDefaultValue::Null,
                    datatype:      WotXmlType::Vector3,
                    size:          12,
                },
                PropData {
                    name:          "simulationData_rotation",
                    default_value: WotXmlDefaultValue::Null,
                    datatype:      WotXmlType::Vector3,
                    size:          12,
                },
                PropData {
                    name:          "simulationData_velocity",
                    default_value: WotXmlDefaultValue::Null,
                    datatype:      WotXmlType::Vector3,
                    size:          12,
                },
                PropData {
                    name:          "simulationData_angVelocity",
                    default_value: WotXmlDefaultValue::Null,
                    datatype:      WotXmlType::Vector3,
                    size:          12,
                },
                ...
                PropData {
                    name:          "simulationData_simulationType",
                    default_value: WotXmlDefaultValue::Str(""),
                    datatype:      WotXmlType::String,
                    size:          65535,
                },
                PropData {
                    name:          "simulationData_damageStickers",
                    default_value: WotXmlDefaultValue::Null,
                    datatype:      WotXmlType::Array {
                        inner: &WotXmlType::UInt64,
                        size:  None,
                ...
                PropData {
                    name:          "simulationData_brokenTracks",
                    default_value: WotXmlDefaultValue::Null,
                    datatype:      WotXmlType::Array {
                        inner: &WotXmlType::FixedDict {
                            inner:      &[
                                ("isBroken", WotXmlType::UInt8),
                                ("hitPoint", WotXmlType::Vector3),
                                ("isDebris", WotXmlType::UInt8),
                            ],
                            allow_none: false,
                        },
                        size:  None,
                ...
                PropData {
                    name:          "simulationData_wheelsSteering",
                    default_value: WotXmlDefaultValue::Null,
                    datatype:      WotXmlType::Array {
        ...
        EntityData {
            ...
            exposed_props:   &[
                ...
                PropData {
                    name:          "proximityMarkerStyle",
                    default_value: WotXmlDefaultValue::Str("STATIC_DEATH_ZONE_PROXIMITY"),
                    datatype:      WotXmlType::String,
                    size:          65535,
                },
            ],
        ...
        EntityData {
            ...
            exposed_props:   &[
                ...
                PropData {
                    ...
                    datatype:      WotXmlType::Array {
                        inner: &WotXmlType::FixedDict {
                            inner:      &[("id", WotXmlType::String), ("state", WotXmlType::UInt8)],
                            allow_none: false,
                        },
                        size:  None,
                    },
            ...
            exposed_methods: &[
                ...
                MethodData {
                    name: "activateGameObjectUnique",
                    args: &[WotXmlType::String],
                    size: 65536,
                },
                MethodData {
                    name: "deactivateGameObjectUnique",
                    args: &[WotXmlType::String],
                    size: 65536,
                },
                MethodData {
                    name: "removeGameObjectUnique",
                    args: &[WotXmlType::String],
                    size: 65536,
                },
            ],
