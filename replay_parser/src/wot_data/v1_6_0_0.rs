...
pub(crate) const DATA_1_6_0_0: WotDataForVersion = WotDataForVersion {
    ...
    entities: &[
        EntityData {
            ...
            exposed_props:   &[
                PropData {
                    name:          "requiredVersion_16000",
                    default_value: WotXmlDefaultValue::Str("	ru_1.6.0_7	"),
                    datatype:      WotXmlType::String,
                    size:          65535,
                },
                PropData {
        ...
        EntityData {
            ...
            exposed_props:   &[
                ...
                PropData {
                    name:          "isSurfaceContact",
                    default_value: WotXmlDefaultValue::Bool(true),
                    datatype:      WotXmlType::UInt8,
                    size:          1,
                },
                PropData {
            ...
            exposed_methods: &[
                MethodData {
                    name: "onDropCapturePointsOnDamagedByEnemy",
                    args: &[],
                    size: 1,
                },
                MethodData {
        ...
        EntityData {
            ty:              ClientSelectableFrontLineHangarObject,
            exposed_props:   &[],
            exposed_methods: &[],
        },
        EntityData {
            ty:              ClientSelectableMarathonHangarObject,
            exposed_props:   &[],
            exposed_methods: &[],
        },
        EntityData {
            ty:              ClientSelectableAdventCalendarHangarObject,
            exposed_props:   &[],
            exposed_methods: &[],
        },
        EntityData {
            ty:              ClientSelectableRacingHangarObject,
            exposed_props:   &[],
            exposed_methods: &[],
        },
        EntityData {
            ty:              ClientSelectableMiniGamesHangarObject,
            exposed_props:   &[],
            exposed_methods: &[],
        },
        EntityData {
            ty:              ClientSelectableMusicStageObject,
            exposed_props:   &[
                PropData {
                    name:          "initialCameraName",
                    default_value: WotXmlDefaultValue::Str(""),
                    datatype:      WotXmlType::String,
                    size:          65535,
                },
