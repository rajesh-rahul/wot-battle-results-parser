...
pub(crate) const DATA_1_14_0_0: WotDataForVersion = WotDataForVersion {
    ...
    entities: &[
        EntityData {
            ...
            exposed_props:   &[
                PropData {
                    name:          "requiredVersion_11400",
                    default_value: WotXmlDefaultValue::Str("	ru_1.14.0_7	"),
                    datatype:      WotXmlType::String,
                    size:          65535,
                },
                PropData {
